...
export const INSTRUMENT = {
  ...
  trombone: () => {
    ...
    const bell = makePart(48 - BB, 20, 14, 13, (d) => {
      ...
      d.r(32 - BB, 11, 6, 2, C.gold); d.r(38 - BB, 10, 4, 4, C.gold); d.r(42 - BB, 9, 3, 6, C.gold); d.r(45 - BB, 8, 1, 8, C.gold); d.r(46 - BB, 7, 1, 10, C.gold); d.r(47 - BB, 6, 1, 12, C.gold2);
    }, { res: 2, depth: 24, z0: -18,
         side: (d) => { d.disc(18, 11, 6, F); d.r(17, 11, 2, 7, F); },
         top: (d) => {
           d.r(0, 17, 33 - BB, 1, F);                                                          // ベル管（z 17。半径 0.5px）
           d.r(32 - BB, 17, 6, 2, F); d.r(38 - BB, 16, 4, 4, F); d.r(42 - BB, 15, 3, 6, F); d.r(45 - BB, 14, 1, 8, F); d.r(46 - BB, 13, 1, 10, F); d.r(47 - BB, 12, 1, 12, F); // ベル（中心 z 17.5）：半径 1→2→3→4→5→6
         },
         carve: (x, y, z) => {
           if (x < 42 - BB) return false;                                                     // 根元の 2 段（半径 1・2）は塞いだまま：管からの立ち上がり
           const R = x >= 47 - BB ? 6 : x >= 46 - BB ? 5 : x >= 45 - BB ? 4 : 3; const r = R - 1.2; const dy = y - 11.5, dz = z - 17.5; return dy * dy + dz * dz < r * r; // ベルの穴
         } });
