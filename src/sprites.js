...
export const INSTRUMENT = {
  ...
  }, { res: 2, depth: 14, z0: 0, side: (d) => { d.r(12, 4, 2, 14, F); d.r(2, 16, 10, 6, F); d.r(0, 22, 14, 41, F); d.r(6, 64, 2, 4, F); }, back: STRING_BACK(C.wood) }), scrollPart(C.wood2, 5), [0, 64, 13], 'y',
    { w: 3, h: 36, pos: [-1, 64, 14], thick: 1 }),   // pivot が 8 セル上がったので、渦巻き・指板の y も 72 → 64 // ネックは表板側 2 セル（＋指板 1 セル。2026-09-16 ユーザー指定で薄く）。渦巻きもその中心へ。指板は表板（z 14）の上に 1 セル // 厚み 16 → 14 セル（42cm → 37cm。2026-09-11）
