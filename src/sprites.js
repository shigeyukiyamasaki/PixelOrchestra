...
export const INSTRUMENT = {
  ...
  trombone: () => {
    ...
    const body = makePart(34, 20, 0, 13, (d) => {
      ...
      d.r(3, 13, 28 - BB, 1, C.gold2); d.r(3, 17, 28 - BB, 1, C.gold2);                       // 内管（上・下。外管が伸びると露出）
      d.r(2, 16, 2, 2, C.gold);                                                               // 下の内管の端（横管への口）
    }, { res: 2, depth: 12, z0: -6, side: (d) => { d.r(4, 0, 4, 20, F); }, top: (d) => { d.r(0, 5, 32 - BB, 2, F); } });
    const bell = makePart(48 - BB, 20, 14, 13, (d) => {
      ...
      d.r(16, 11, 16 - BB, 1, '#f3d27a');
         ...
         top: (d) => {
           d.r(0, 17, 33 - BB, 2, F); d.r(16, 9, 2, 10, F);                                    // ネックパイプ・U ターン・ベル管（z 17-18）／横管（x 16-17, z 9-18。ロール後の下の内管の端から）
