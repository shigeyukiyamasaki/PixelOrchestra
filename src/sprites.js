...
export const INSTRUMENT = {
  ...
  trombone: () => {
    ...
    const bell = makePart(48 - BB, 20, 14, 13, (d) => {
      ...
      // ベル（rows 6-17）。一番広がった部分は濃い色のフチだけ 2px 残す（明るい色の 3px 幅を削除。分厚すぎた。2026-09-12 ユーザー指定）
      d.r(32 - BB, 10, 3, 4, C.gold); d.r(35 - BB, 9, 3, 6, C.gold); d.r(38 - BB, 8, 3, 8, C.gold); d.r(41 - BB, 6, 2, 12, C.gold2);
      d.r(16, 11, 16 - BB, 1, '#f3d27a');
    }, { res: 2, depth: 24, z0: -18,
         side: (d) => { d.disc(18, 11, 6, F); d.r(17, 11, 2, 7, F); },
         top: (d) => {
           d.r(0, 17, 33 - BB, 2, F);                                                          // ベル管（z 17-18）
           d.r(32 - BB, 16, 3, 4, F); d.r(35 - BB, 15, 3, 6, F); d.r(38 - BB, 13, 3, 10, F); d.r(41 - BB, 12, 5, 12, F); // ベル（中心 z 17.5）
         },
         carve: (x, y, z) => {
