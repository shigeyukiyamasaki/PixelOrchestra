...
export const INSTRUMENT = {
  ...
  cello: () => withScroll(makePart(24, 60, 12, 60, (d) => {
    ...
    d.r(12, 52, 1, 8, C.silver);                                           // エンドピン（幅 1 セル。2026-09-16 ユーザー指定：細く）
  }, { res: 2, depth: 8, z0: 0, side: (d) => { d.r(7, 0, 1, 16, F); d.r(1, 14, 6, 4, F); d.r(0, 18, 8, 30, F); d.r(1, 48, 6, 4, F); d.r(4, 52, 1, 8, F); }, back: STRING_BACK(C.wood) }), scrollPart(C.wood2, 4), [0, 57, 7.5], 'y',
