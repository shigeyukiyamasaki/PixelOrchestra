...
export const INSTRUMENT = {
  ...
  contrabass: () => withScroll(makePart(28, 76, 14, 68, (d) => {
    ...
    { w: 3, h: 36, pos: [-1, 64, 9], thick: 1 }),   // 胴の厚み 14 → 9 セル（2/3。2026-09-16 ユーザー指定）。ネックは表板側 2 セル、渦巻きは z 8、指板は表板（z 9）の上 // ネックは表板側 2 セル（＋指板 1 セル。2026-09-16 ユーザー指定で薄く）。渦巻きもその中心へ。指板は表板（z 14）の上に 1 セル // 厚み 16 → 14 → 9 セル（2026-09-11 / 2026-09-16）
