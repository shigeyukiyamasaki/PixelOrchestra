...
export const INSTRUMENT = {
  ...
  cello: () => withScroll(makePart(24, 60, 12, 60, (d) => {
    ...
    d.r(11, 36, 2, 10, C.black); d.r(10, 46, 4, 3, C.black);                // 弦（黒。駒 row 33 の下 2 行を空ける）・テールピース（胴の下端 row 48 で止める。2026-09-16 ユーザー指定）
  ...
  contrabass: () => withScroll(makePart(28, 76, 14, 72, (d) => {
    ...
    d.r(13, 45, 3, 8, C.black); d.r(12, 53, 4, 10, C.black);                // 弦（黒・幅は指板と同じ 3 セル。駒 row 42 の下 2 行を空ける。2026-09-16 ユーザー指定）・テールピース
