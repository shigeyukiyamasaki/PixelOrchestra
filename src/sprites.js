...
export const INSTRUMENT = {
  ...
  cello: () => withScroll(makePart(24, 60, 12, 60, (d) => {
    ...
    d.r(11, 34, 2, 12, '#3a3a44'); d.r(10, 46, 4, 3, C.black);              // 弦・テールピース（胴の下端 row 48 で止める。下へはみ出していた黒を削った。2026-09-16 ユーザー指定）
    d.r(12, 49, 1, 11, C.silver);                                          // エンドピン（幅 1 セル、胴の直下 row 49 から。2026-09-16 ユーザー指定：細く・長く見えて OK）
  }, { res: 2, depth: 8, z0: 0, side: (d) => { d.r(7, 0, 1, 16, F); d.r(1, 14, 6, 4, F); d.r(0, 18, 8, 30, F); d.r(4, 49, 1, 11, F); }, back: STRING_BACK(C.wood) }), scrollPart(C.wood2, 4), [0, 57, 7.5], 'y',
  ...
  }, { res: 2, depth: 9, z0: 0, side: (d) => { d.r(7, 4, 2, 14, F); d.r(1, 16, 7, 6, F); d.r(0, 22, 9, 41, F); d.r(4, 64, 1, 8, F); }, back: STRING_BACK(C.wood) }), scrollPart(C.wood2, 5), [0, 68, 8], 'y',
    { w: 3, h: 36, pos: [-1, 68, 9], thick: 1 }),   // 胴の厚み 14 → 9 セル（2/3。2026-09-16 ユーザー指定）。ネックは表板側 2 セル、渦巻きは z 8、指板は表板（z 9）の上。y は pivot（row 72）基準で 72-4 = 68 // ネックは表板側 2 セル（＋指板 1 セル。2026-09-16 ユーザー指定で薄く）。渦巻きもその中心へ。指板は表板（z 14）の上に 1 セル // 厚み 16 → 14 → 9 セル（2026-09-11 / 2026-09-16）
