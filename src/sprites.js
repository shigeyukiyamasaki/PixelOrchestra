...
export const INSTRUMENT = {
  ...
  // 弓 52×1（2 倍解像度＝26px。40 から 1.3 倍に延長、2026-09-10 ユーザー指定）。pivot = フロッグ（手元）
  // 断面は指揮棒と同じ 1×1 セル（2026-09-16 ユーザー指定：細く）。1 行なので毛の白線は描けない。先端だけ象牙色
  bow: () => makePart(52, 1, 2, 0.5, (d) => { d.r(0, 0, 52, 1, C.wood2); d.r(0, 0, 3, 1, C.black); d.p(51, 0, C.ivory); }, { res: 2, depth: 1, z0: -0.5 }),
