...
export const INSTRUMENT = {
  ...
  }, { res: 2, depth: 8, z0: 0, side: (d) => { d.r(7, 0, 1, 16, F); d.r(1, 14, 6, 4, F); d.r(0, 18, 8, 30, F); d.r(1, 48, 6, 4, F); d.r(3, 52, 2, 8, F); }, back: STRING_BACK(C.wood) }), scrollPart(C.wood2, 4), [0, 57, 7.5], 'y',
  ...
  // エンドピンを 12 → 4 セルに短縮し、pivot（床に着く点）を row 68 へ（2026-09-16 ユーザー指定：ピンを短く）。
  // 前のめりで胴が床に沈む問題は、ピンの長さではなく「楽器を床に立てたままにする」（puppet.js の floorStand）で対処
  contrabass: () => withScroll(makePart(28, 76, 14, 68, (d) => {
    ...
    d.r(13, 64, 2, 4, C.silver);                                           // エンドピン（短い。rows 64-67）
  }, { res: 2, depth: 9, z0: 0, side: (d) => { d.r(7, 4, 2, 14, F); d.r(1, 16, 7, 6, F); d.r(0, 22, 9, 41, F); d.r(4, 64, 2, 4, F); }, back: STRING_BACK(C.wood) }), scrollPart(C.wood2, 5), [0, 64, 8], 'y',
    { w: 3, h: 36, pos: [-1, 64, 9], thick: 1 }),   // 胴の厚み 14 → 9 セル（2/3。2026-09-16 ユーザー指定）。ネックは表板側 2 セル、渦巻きは z 8、指板は表板（z 9）の上。y は pivot（row 68）基準で 68-4 = 64 // ネックは表板側 2 セル（＋指板 1 セル。2026-09-16 ユーザー指定で薄く）。渦巻きもその中心へ。指板は表板（z 14）の上に 1 セル // 厚み 16 → 14 → 9 セル（2026-09-11 / 2026-09-16）
