...
const VARIANT = {
  ...
  timpani:    { inst: { pos: [0, 15, 4], rot: 0 }, held: { L: 'mallet', R: 'mallet' },
                ...
                p3: { strike: { L: { hit: [-7, 19, 8], rest: [-9, 21, 7], head: [-6, 15.5, 15] }, R: { hit: [7, 19, 8], rest: [9, 21, 7], head: [6, 15.5, 15] } } } }, // 手首は体の前 8px（肘を前に出す）
  ...
  snare:      { inst: { pos: [0, 17, 4], rot: 0 }, held: { L: 'stick', R: 'stick' },
                ...
                p3: { strike: { L: { hit: [-4, 20, 7], rest: [-5, 22, 7], head: [-3, 18, 15] }, R: { hit: [4, 20, 7], rest: [5, 22, 7], head: [3, 18, 15] } } } }, // 手首は体の前 7px
